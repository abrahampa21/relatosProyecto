...
const StoryReader: React.FC<StoryReaderProps> = ({ story, onGoBack }) => {
  ...
  return (
    <div className="min-h-screen bg-black pb-24 relative">
      {story.animationType !== AnimationType.BlackCat || story.animationType !== AnimationType.Morgue && (
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
        <header className="text-center mb-12 flex flex-col items-center">
          <div className="img w-48 h-48 mb-6 border-4 border-gray-700 rounded-full overflow-hidden shadow-lg shadow-red-900/30">
